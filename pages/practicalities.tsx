        ...
        <div className="document content">
          ...
          <p>
            ...
            applies if you are interested in just holding a presentation and not
             attending the rest of the conference. Our ambition is that everyone 
             attends the entire conference to meet and learn from fellow colleagues 
             at other Knowit companies.
          </p>
          <p>  
