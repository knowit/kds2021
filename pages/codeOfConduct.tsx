        ...
        <div className="codeOfConduct page">
            <Layout title="Code of conduct" background={true}>
                <div className="document coc">
                    ...
                    <p className="paragraph">
                        We encourage inclusive language in conference talks. A good starting point towards inclusive
                        language is to avoid default-gendered words like "guys"/"gals"/"him"/"her" when talking
                        generally about a group of people. A tip is to try out words like "people"/"everyone" or "the
                        team"/"the developers".
                    </p>
                    <p className="paragraph">
